 ...
 * bias.
 */
	float kalman_updateX(
	const float q_m,        /*Gyro roll measurement*/
	const float	ax_m,	/* Y acceleration */
	const float	az_m,	/* Z acceleration */
	const float dt
)
{
	/* Unbias our gyro */
	const float		q = q_m - q_bias_x;
	...
	const float		angle_err = angle_m - angle_x;
