 ...
 * the angle, we also have an unbiased angular rate_y available.   These are
...
)
{
	...
	const float		angle_err = angle_m - angle_y;
	 ...
	 * angle.
	 */
	angle_y	+= K_0 * angle_err;
	q_bias_y	+= K_1 * angle_err;
	return(angle_y);
}
